...
const getPedidos = (request, response) => {
    pool.query("select id, Numero_Phoenix , Cnpj,Nome,Endereco,Numero,Complemento,Bairro,Cidade,Estado,Cep,DDD,Telefone,EmailComercial,EmailCobranca,Emissao,Entrega,EntregaMaxima,PedidoDoCliente,Vendedor,AgenteDeVenda,Transportadora,FretePorConta,OperadorLeasing,Distribuidora,UsoDaMercadoria,Ent_MesmoEndereco,Ent_Cnpj,Ent_Endereco,Ent_Numero,Ent_Complemento,Ent_Bairro,Ent_Cidade,Ent_Estado,CondicaoDePagamentoFat,ValorFinanciado,TipoDeFinanciamento from Pedidos_Cab order by id", (error, results) => {
        if (error) {
...
//       const { id_original , NumeroDoPedido , Situacao , DataPrevista , DataDaOcorrencia , MensagemDeLog , Arquivo , Nome, Email, Cpf_Cnpj, ddi , ddd , Telefone, Cep, Cidade, Uf, assunto, id_Segmento, id_Produto  , criacao , id_origem , mensagem , Produtos } = request.body
   ...
   let Ins3 = await pool.query
           (
'insert into pedidos_cab( Cnpj,Nome,Endereco,Numero,Complemento,Bairro,Cidade,Estado,Cep,DDD,Telefone,EmailComercial,EmailCobranca,Emissao,Entrega,EntregaMaxima,PedidoDoCliente,Vendedor,AgenteDeVenda,Transportadora,FretePorConta,OperadorLeasing,Distribuidora,UsoDaMercadoria,Ent_MesmoEndereco,Ent_Cnpj,Ent_Endereco,Ent_Numero,Ent_Complemento,Ent_Bairro,Ent_Cidade,Ent_Estado,CondicaoDePagamentoFat,ValorFinanciado,TipoDeFinanciamento,Situacao_Proc ) '+
...
//            [ id_original , NumeroDoPedido , Situacao , DataPrevista , DataDaOcorrencia , MensagemDeLog , Arquivo , 0 , Nome, Email, Cpf_Cnpj, ddi , ddd , Telefone, Cep, Cidade, Uf, assunto, id_Segmento, id_Produto , criacao , id_origem , mensagem , '0' ]
              [ Cnpj,Nome,Endereco,Numero,Complemento,Bairro,Cidade,Estado,Cep,DDD,Telefone,EmailComercial,EmailCobranca,Emissao,Entrega,EntregaMaxima,PedidoDoCliente,Vendedor,AgenteDeVenda,Transportadora,FretePorConta,OperadorLeasing,Distribuidora,UsoDaMercadoria,Ent_MesmoEndereco,Ent_Cnpj,Ent_Endereco,Ent_Numero,Ent_Complemento,Ent_Bairro,Ent_Cidade,Ent_Estado,CondicaoDePagamentoFat,ValorFinanciado,TipoDeFinanciamento , '0' ]
           )
        if (Ins3.rows[0] )
           {
...
const getPedidos_Phoenix = async (request, response) => 
{
    ...
    try
   {
       ...
       Get3 = await pool.query("select id, numero_phoenix , Cnpj,Nome,Endereco,Numero,Complemento,Bairro,Cidade,Estado,Cep,DDD,Telefone,EmailComercial,EmailCobranca,Emissao,Entrega,EntregaMaxima,PedidoDoCliente,Vendedor,AgenteDeVenda,Transportadora,FretePorConta,OperadorLeasing,Distribuidora,UsoDaMercadoria,Ent_MesmoEndereco,Ent_Cnpj,Ent_Endereco,Ent_Numero,Ent_Complemento,Ent_Bairro,Ent_Cidade,Ent_Estado,CondicaoDePagamentoFat,ValorFinanciado,TipoDeFinanciamento from pedidos_cab Where ( Situacao_proc = '0'  ) "+
       " order by id ")
